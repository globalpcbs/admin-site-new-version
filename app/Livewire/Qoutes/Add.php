    ...
    public function saveproccess()
    {
       // dd($this->blind);
        ...
        $orderData = [
            ...
            'fingers_gold' => $this->fingers_gold ? 'yes' : null,
            'trace_min' => $this->trace_min,
            'space_min' => $this->space_min,
            'con_impe_sing' => $this->con_impe_sing ? 'yes' : null,
            'con_impe_diff' => $this->con_impe_diff ? 'yes' : null,
            'tore_impe' => $this->tore_impe,
            'hole_size' => $this->hole_size,
            'pad' => $this->pad,
            'blind' => $this->blind ? 'yes' : null,
            'buried' => $this->buried ? 'yes' : null,
            'hdi_design' => $this->hdi_design ? 'yes' : null,
            'finish' => $this->finish,
            ...
            'array' => $this->array ? 'yes' : null,
            'b_per_array' => $this->b_per_array,
            'array_size1' => $this->array_size1,
            'array_size2' => $this->array_size2,
            'route_tole' => $this->route_tole,
            'array_design' => $this->array_design ? 'yes' : null,
            'design_array' => $this->design_array ? 'yes' : null,
            'array_type1' => $this->array_type1 ? 'yes' : null,
            'array_type2' => $this->array_type2 ? 'yes':null,
            'array_require1' => $this->array_require1 ? 'yes' : null,
            'array_require2' => $this->array_require2 ? 'yes' : null,
            'array_require3' => $this->array_require3 ? 'yes' : null,
            'bevel' => $this->bevel ? 'yes' : null,
            'counter_sink' => $this->counter_sink ? 'yes' : null,
            'cut_outs' => $this->cut_outs ? 'yes' : null,
            'slots' => $this->slots ? 'yes' : null,
            'logo' => $this->logo,
            'mark' => $this->mark ? 'yes' : null,
            'date_code' => $this->date_code,
            'other_marking' => $this->other_marking,
            'micro_section' => $this->micro_section ? 'yes' : null,
            'test_stamp' => $this->test_stamp ? 'yes' : null,
            'in_board' => $this->in_board ? 'yes' : null,
            'array_rail' => $this->array_rail ? 'yes' : null,
            'xouts' => $this->xouts ? 'yes' : null,
            'xouts1' => $this->xoutsnum,
            'rosh_cert' => $this->rosh_cert ? 'yes' : null,
            ...
            'cond_vias' => $this->cond_vias ? 'yes' : null,
            'resin_filled' => $this->resin_filled ? 'yes' : null,
