...
class Manage extends Component
{
    ...
    // Reset dropdowns when inputs change
    public function updatedSearchPartNoInput($value)
    {
        if (empty($value)) {
            $this->matches_partno = [];
        }
    ...
    public function updatedSearchCustomerInput($value)
    {
        if (empty($value)) {
            $this->matches = [];
        }
    ...
    public function useMatch($i)
    {
        ...
        $this->matches = []; // Clear dropdown after selection
    }
    ...
    public function useMatchpn($i)
    {
        ...
        $this->matches_partno = []; // Clear dropdown after selection
    }
