                    ...
                    <tbody>
                        @forelse ($customers as $customer)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-danger btn-sm" wire:confirm="Are you sure you want to delete this customer?" wire:click="deleteCustomer({{ $customer->data_id }})" wire:key="delete-{{ $customer->data_id }}">
