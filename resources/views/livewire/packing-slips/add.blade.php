<div>
    ...
    <div class="card">
        <div class="card-header">
            <i class="fa fa-plus-circle"></i> Add Packing Slips
        </div>
        ...
        <div class="card-body">
            <form wire:submit.prevent="save" onkeydown="if(event.key === 'Enter') event.preventDefault();">
                ...
                {{-- Packing Items --}}
                <h5 class="mb-3"><i class="fa fa-list"></i> Packing Items</h5>
                <div class="table-responsive mb-3">
                    <table class="table table-bordered align-middle text-center">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><input type="text" class="form-control" wire:model.lazy="items.{{ $index }}.item">
                                </td>
                                <td><input type="text" class="form-control" wire:model.lazy="items.{{ $index }}.desc">
                                </td>
                                <td><input type="text" class="form-control" wire:model.lazy="items.{{ $index }}.qty">
                                </td>
                                <td><input type="text" class="form-control"
                                        wire:model.lazy="items.{{ $index }}.shipqty"></td>
                            </tr>
                            @endforeach
                        </tbody>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-6">
                        <label class="form-label"><i class="fa fa-users"></i> Customer Main Contact
                            <div class="form-check" style="max-height:150px; overflow-y:auto;">
                                @if(!empty($availableMaincontacts))
                                @foreach($availableMaincontacts as $contact)
                                <div>
                                    <input type="checkbox" class="form-check-input" wire:model="maincontacts"
                ...
                <div class="mt-3">
                    ...
                    <!-- <a href="{{ route('dashboard') }}" class="btn btn-link">
                        <i class="fa fa-home"></i> Go back to front page
                    </a> -->
                </div>
            </form>
        </div>
            ...
            <div class="modal-content" style="background: #ccffff; border: 1px solid #999; font-size: 13px;">
                ...
                <div class="modal-body pt-2 px-3">
                    ...
                    <div class="d-flex flex-wrap gap-2">
                        @foreach(['quo' => 'Quote', 'con' => 'Confirmation','po' => 'Purchase Order', 'inv' => 'Invoice', 'cre' => 'Credit'] as $value => $label)
