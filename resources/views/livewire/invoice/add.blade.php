    ...
    <div class="card">
        ...
        <div class="card-body">
            <form wire:submit.prevent="save" onkeydown="if(event.key === 'Enter') event.preventDefault();">
                ...
                <div class="row mb-3">
                    <div class="col-sm-6">
                        <label for="" class="col-form-label"><i class="fa fa-user"></i> Sold To</label>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select wire:model.live="svia" class="form-control">
                ...
                <table class="table table-bordered table-striped align-middle text-nowrap">
                    ...
                    <tfoot>
                        ...
                        <tr class="table-light">
                            ...
                            <th class="text-end py-2 fs-6 fw-bold">
                                ${{ number_format($this->totalCommission, 2) }}
                            </th>
                            <th></th>
                        </tr>
                    </tfoot>
        ...
        initTimer = setTimeout(initCommentsEditor, 300);
                ...
                <div class="text-end">
                    <button type="submit" class="btn btn-primary @if($button_status == 1) disabled @endif">
                        <i class="fa fa-save"></i> Save Invoice <i class="fa fa-spinner fa-spin" wire:loading></i>
                    </button>
                </div>
            </form>
        </div>
