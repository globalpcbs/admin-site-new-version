<div>
    ...
    <script>
        ...
        // Fetch part number suggestions from server for confirmation orders
        async function fetchPartNoSuggestions(query) {
            ...
            try {
                const response = await fetch(`/api/confirmation-partno-suggestions?q=${encodeURIComponent(query)}`);
        ...
        // Fetch customer suggestions from server for confirmation orders
        async function fetchCustomerSuggestions(query) {
            ...
            try {
                const response = await fetch(`/api/confirmation-customer-suggestions?q=${encodeURIComponent(query)}`);
                const data = await response.json();
                return data;
            } catch (error) {
