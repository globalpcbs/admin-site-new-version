    ...
    <form wire:submit.prevent="save" onkeydown="if(event.key === 'Enter') event.preventDefault();">
        <div class="card mb-3">
            <div class="card-header bg-primary text-white">
                <i class="fa fa-edit"></i> Edit Vendor Profile
            </div>
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <button type="button" class="btn btn-sm btn-outline-primary mt-2 mb-2 float-end" wire:click="addRequirement">
                    ...
                    @foreach($requirements as $index => $req)
                        <div class="input-group mb-2">
                            ...
                            @if(count($requirements) > 1)
                                <button type="button" class="btn btn-danger" wire:click="removeRequirement({{ $index }})">
