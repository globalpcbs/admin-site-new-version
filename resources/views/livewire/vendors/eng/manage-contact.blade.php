                    ...
                    <tbody>
                        @forelse ($contacts as $index => $contact)
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-danger btn-sm" wire:click="deleteContact({{ $contact->enggcont_id }})" wire:confirm="Are you sure? you want to delete." wire:key="delete-{{ $contact->enggcont_id }}">
